...
_gremlin_insert_vertices = [
    "g.addV('person').property('demo2','hello').property('id', 'thomas').property('firstName', 'Thomas').property('age', 44).property('pk', 'demo2')",
    "g.addV('person').property('demo2','hello2').property('id', 'mary').property('firstName', 'Mary').property('lastName', 'Andersen').property('age', 39).property('pk', 'demo2')",
    "g.addV('person').property('demo2','hello3').property('id', 'ben').property('firstName', 'Ben').property('lastName', 'Miller').property('pk', 'demo2')",
    "g.addV('person').property('demo2','hello4').property('id', 'robin').property('firstName', 'Robin').property('lastName', 'Wakefield').property('pk', 'demo2')"
]
...
try:
    ...
    #client = client.Client('https://<INSERT HOST>.gremlin.cosmos.azure.com:443/', 'g',
                           username="/dbs/demograph/colls/playgraph",
